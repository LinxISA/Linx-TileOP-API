...
static_assert(VecM16::Loc == Location::Vec);
static_assert(VecM16::BFractal == BLayout::CubeM16);
static_assert(VecM16::CubeCellRows == 16);
static_assert(VecM16::CubeLoadLayout == LayoutCvtEnum::ND2M16);
static_assert(VecM16::CubeStoreLayout == LayoutCvtEnum::M162ND);
static_assert(VecM16::CubeRequiredBytes == 2048);
static_assert(VecM16::CubeStorageIndex(1, 2) == M16::CubeStorageIndex(1, 2));
static_assert(VecM16Partial::CubeRequiredBytes == 2048);
static_assert(VecM32::Loc == Location::Vec);
static_assert(VecM32::BFractal == BLayout::CubeM32);
static_assert(VecM32::CubeCellRows == 32);
static_assert(VecM32::CubeLoadLayout == LayoutCvtEnum::ND2M32);
static_assert(VecM32::CubeStoreLayout == LayoutCvtEnum::M322ND);
static_assert(VecM32::CubeRequiredBytes == 4096);
