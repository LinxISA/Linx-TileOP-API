...
using OrdinaryFp16 =
    Tile<Location::Vec, __half, 16, 16, BLayout::RowMajor, 16, 15>;
using OrdinaryFp32 =
    Tile<Location::Vec, float, 16, 16, BLayout::RowMajor, 16, 16>;
...
#if defined(SHOULD_FAIL_TCVT_VALID_SHAPE)
void mismatched_ordinary_valid_shape(OrdinaryFp32 &dst, OrdinaryFp16 &src) {
  TCVT(dst, src);
}
#endif
