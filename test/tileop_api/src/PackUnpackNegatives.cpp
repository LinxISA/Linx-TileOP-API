...
void oversized_left_width(WordsM32 &dst, WordsM32 &a, WordsM32 &b) { TPACK(dst, a, b, 0x00000204); }
#endif
#if defined(SHOULD_FAIL_PACK_SUM_TOO_WIDE)
void combined_width_overflow(WordsM32 &dst, WordsM32 &a, WordsM32 &b) { TPACK(dst, a, b, 0x00000303); }
#endif
#if defined(SHOULD_FAIL_PACK_HIGH_BITS)
void nonzero_high_control_bits(WordsM32 &dst, WordsM32 &a, WordsM32 &b) { TPACK(dst, a, b, 0x0000000100000202); }
#endif
...
void zero_count(WordsM32 &dst, WordsM32 &a) { TUNPACK(dst, a, 0x00000001); }
#endif
#if defined(SHOULD_FAIL_UNPACK_COUNT_TOO_LARGE)
void oversized_count(WordsM32 &dst, WordsM32 &a) { TUNPACK(dst, a, 0x00000500); }
#endif
#if defined(SHOULD_FAIL_UNPACK_SUM_TOO_WIDE)
void offset_count_overflow(WordsM32 &dst, WordsM32 &a) { TUNPACK(dst, a, 0x00000402); }
#endif
