...
__attribute__((noinline)) Parent unary_subview_assemble(SourceParent &parent) {
...
int main() { SourceParent p; auto out = unary_subview_assemble(p); asm volatile("" : : "Tr"(out.data())); }
