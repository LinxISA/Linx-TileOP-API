...
__attribute__((noinline)) void mg_add(D &old, Idx16 &ix, D &v) {
  MGATHER_ADD(old, 0x1000ull, ix, v, 256, 2);
}
__attribute__((noinline)) void mg_max(D &old, Idx16 &ix, D &v) {
  MGATHER_MAX(old, 0x1000ull, ix, v, 256, 2);
}
__attribute__((noinline)) void mg_min(D &old, Idx16 &ix, D &v) {
  MGATHER_MIN(old, 0x1000ull, ix, v, 256, 2);
}
__attribute__((noinline)) void mg_and(D &old, Idx16 &ix, D &v) {
  MGATHER_AND(old, 0x1000ull, ix, v, 256, 2);
}
__attribute__((noinline)) void mg_or(D &old, Idx16 &ix, D &v) {
  MGATHER_OR(old, 0x1000ull, ix, v, 256, 2);
}
__attribute__((noinline)) void mg_xor(D &old, Idx16 &ix, D &v) {
  MGATHER_XOR(old, 0x1000ull, ix, v, 256, 2);
}
__attribute__((noinline)) void mg_exch(D &old, Idx4 &ix, D &rep) {
  MGATHER_EXCH(old, 0x1000ull, ix, rep, 256, 2);
}
__attribute__((noinline)) void mg_inc(D &old, Idx16 &ix, D &lim) {
  MGATHER_INC(old, 0x1000ull, ix, lim, 256, 2);
}
__attribute__((noinline)) void mg_dec(D &old, Idx16 &ix, D &lim) {
