...
class LinxISAV058EngineContractTest(unittest.TestCase):
    ...
    def test_range_modifiers_expose_simple_factories(self) -> None:
        ...
        self.assertIn("auto sv = range::subview<2047>(s);", tile)
        self.assertIn("auto sv = range::subview<2047>(s, base);", tile)
        ...
        self.assertIn("Offset_ = 0, typename Parent", tile_header)
